...
class account{
	...
	double balance;
	public:
	 account(long acc_no,int acc_type=1,double acc_balance=500);// Constructor prototype declarartion
	...
	account::account(long acc_no,int acc_type,double acc_balance){
...
// main program
int main(){
	account Smile(12344);// implicit constructor calling
